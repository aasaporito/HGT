...
| `-o`              | Output file identifier for result mode                                                                                                                                                                           | <center>--</center>                | <center>--results</center>        |
...
| `-pp`              | Result post-processing for fragmenting mode. Filters all results out that include non-sequential genome pairings. Post-processing is only compatible when --size == --min-frags.                                 |            <center>--results</center>                                                  | <center>-f/--frag</center> |
